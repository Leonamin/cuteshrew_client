...
class ShrunkLoginWidget extends StatefulWidget {
  const ShrunkLoginWidget({super.key});

  @override
  State<ShrunkLoginWidget> createState() => _ShrunkLoginWidgetState();
}

class _ShrunkLoginWidgetState extends State<ShrunkLoginWidget> {
